...
public class Q4_FindMiddleNode {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new Q4_FindMiddleNode().middleNode(q1_ll1).val);

        // Program-2 : linked list with length : 2
        ListNode q2_ll1 = new ListNode(1, null);
        ListNode q2_ll2 = new ListNode(2, null);
        q2_ll1.next = q2_ll2;
        System.out.println(new Q4_FindMiddleNode().middleNode(q2_ll1).val);
        ...
        q3_ll1.next = q3_ll2;
        q3_ll2.next = q3_ll3;
        System.out.println(new Q4_FindMiddleNode().middleNode(q3_ll1).val);
        ...
        q4_ll2.next = q4_ll3;
        q4_ll3.next = q4_ll4;
        System.out.println(new Q4_FindMiddleNode().middleNode(q4_ll1).val);
        ...
        q5_ll3.next = q5_ll4;
        q5_ll4.next = q5_ll5;
        System.out.println(new Q4_FindMiddleNode().middleNode(q5_ll1).val);
    }
}