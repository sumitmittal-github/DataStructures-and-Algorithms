...
public class Question6_CycleNode {
    ...
    public static void main(String[] args) {
        ...
        q1_ll2.next = q1_ll3;
        q1_ll3.next = q1_ll4;
        System.out.println(new Question6_CycleNode().cycleNode(q1_ll1).val);
        ...
        q2_ll1.next = q2_ll2;
        q2_ll2.next = q2_ll1;
        System.out.println(new Question6_CycleNode().cycleNode(q2_ll1).val);

        // Question-3 : which has a cycle of length : 1
        ListNode q3_ll1 = new ListNode(1, null);
        q3_ll1.next = q3_ll1;
        System.out.println(new Question6_CycleNode().cycleNode(q3_ll1).val);
        ...
        q4_ll2.next = q4_ll3;
        q4_ll3.next = q4_ll4;
        System.out.println(new Question6_CycleNode().cycleNode(q4_ll1));

        // Question-5 : which do not have a cycle
        ListNode q5_ll1 = new ListNode(1, null);
        System.out.println(new Question6_CycleNode().cycleNode(q5_ll1));
    }
