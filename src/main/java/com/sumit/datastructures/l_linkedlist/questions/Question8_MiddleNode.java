...
public class Question8_MiddleNode {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new Question8_MiddleNode().middleNode(q1_ll1).val);

        // Question-2 : which has a cycle of length : 2
        ListNode q2_ll1 = new ListNode(1, null);
        ListNode q2_ll2 = new ListNode(2, null);
        q2_ll1.next = q2_ll2;
        System.out.println(new Question8_MiddleNode().middleNode(q2_ll1).val);

        // Question-3 : which has a cycle of length : 3
        ListNode q3_ll1 = new ListNode(1, null);
        ListNode q3_ll2 = new ListNode(2, null);
        ListNode q3_ll3 = new ListNode(3, null);
        q3_ll1.next = q3_ll2;
        q3_ll2.next = q3_ll3;
        System.out.println(new Question8_MiddleNode().middleNode(q3_ll1).val);

        // Question-4 : which has a cycle of length : 4
        ...
        q4_ll2.next = q4_ll3;
        q4_ll3.next = q4_ll4;
        System.out.println(new Question8_MiddleNode().middleNode(q4_ll1).val);

        // Question-5 : which has a cycle of length : 5
        ...
        q5_ll3.next = q5_ll4;
        q5_ll4.next = q5_ll5;
        System.out.println(new Question8_MiddleNode().middleNode(q5_ll1).val);
    }
